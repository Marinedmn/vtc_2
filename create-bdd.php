...
$db->query('CREATE TABLE vtc_2.association_vehicule_conducteur (
    ...
    CONSTRAINT fk_if_vehicule FOREIGN KEY (id_vehicule) REFERENCES vtc_2.vehicule (id_vehicule) ON DELETE CASCADE,
    CONSTRAINT fk_if_conducteur FOREIGN KEY (id_conducteur) REFERENCES vtc_2.conducteur (id_conducteur) ON DELETE CASCADE
)');
